...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `${baseUrl}${localePath}/tools/age-calculator`,
      languages: { en: `${baseUrl}/tools/age-calculator`, sq: `${baseUrl}/sq/tools/age-calculator` },
    },
  };
}
  ...
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        name: "Age Calculator - Atlas Studio Tools",
        url: "https://tools.atlas-studio.eu/tools/age-calculator",
