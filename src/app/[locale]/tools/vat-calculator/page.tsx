...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `${baseUrl}${localePath}/tools/vat-calculator`,
      languages: { en: `${baseUrl}/tools/vat-calculator`, sq: `${baseUrl}/sq/tools/vat-calculator` },
    },
  };
}
  ...
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        name: "VAT Calculator - Atlas Studio Tools",
        url: "https://tools.atlas-studio.eu/tools/vat-calculator",
