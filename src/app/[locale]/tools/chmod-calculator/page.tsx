...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `${baseUrl}${localePath}/tools/chmod-calculator`,
      languages: { en: `${baseUrl}/tools/chmod-calculator`, sq: `${baseUrl}/sq/tools/chmod-calculator` },
    },
  };
}
  ...
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        name: "Chmod Calculator - Atlas Studio Tools",
        url: "https://tools.atlas-studio.eu/tools/chmod-calculator",
